...
<head>
    ...
    <link rel="icon" href="https://sinergigrafika.com/wp-content/uploads/2019/12/logoonly-sg.png" sizes="32x32" />
    <link rel="icon" href="https://sinergigrafika.com/wp-content/uploads/2019/12/logoonly-sg.png" sizes="192x192" />
    <link rel="apple-touch-icon-precomposed" href="https://sinergigrafika.com/wp-content/uploads/2019/12/logoonly-sg.png" />
...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select" id="warna" name="warna" required>
                                <option value="BW">1 Warna (BW)</option>
                                <option value="CMYK">4 Warna (CMYK)</option>
                            </select>
                        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-result">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Biaya Plat (<span id="jenisPlatResult"></span>)</td>
                                <td>-</td>
                                <td id="hargaPlat"></td>
                                <td id="subtotalPlat"></td>
                            </tr>
                            <!-- <tr>
                                <td>Overprint</td>
    ...
    <script>
        ...
        function hitungBiayaCetak(oplah, jumlahMuka, warna) {
            ...
            if (oplah >= 2000) {
                ...
                hargaOverprint = (mesin === 'SM-74') ? 100 : 80;
            }
            ...
            // Cutting cost
            const biayaPotong = 20000;
            
            // Calculate plate cost
            const hargaPlatSatuan = 15000;
            const jumlahPlat = (warna === 'CMYK') ? 4 : 1;
            const totalBiayaPlat = hargaPlatSatuan * jumlahPlat;
            ...
            // Calculate total cost for Overprint & Kertas Double Folio
            const totalBiayaPrint = totalBiayaOverprint + totalBiayaKertas;
            
            // Calculate total cost (now including plate cost)
            const totalBiaya = hargaCetak + totalBiayaOverprint + totalBiayaKertas + biayaPotong + totalBiayaPlat;
            ...
            return {
                ...
                jumlah_plat: jumlahPlat,
                harga_plat: hargaPlatSatuan,
                total_biaya_plat: totalBiayaPlat,
        ...
        document.getElementById('calculatorForm').addEventListener('submit', function(e) {
            ...
            // Calculate cost
            const hasil = hitungBiayaCetak(oplah, jumlahMuka, warna);
        ...
        function displayResults(hasil) {
            ...
            document.getElementById('jenisPlatResult').textContent = hasil.warna;
            // document.getElementById('jumlahPlat').textContent = hasil.jumlah_plat + ' plat';
            document.getElementById('hargaPlat').textContent = 'Rp ' + formatCurrency(hasil.harga_plat);
            document.getElementById('subtotalPlat').textContent = 'Rp ' + formatCurrency(hasil.total_biaya_plat);
            ...
            // Combined subtotal for Overprint & Kertas Double Folio
            const totalBiayaPrint = hasil.total_biaya_overprint + hasil.total_biaya_kertas;
            document.getElementById('subtotalPrint').textContent = 'Rp ' + formatCurrency(totalBiayaPrint);
